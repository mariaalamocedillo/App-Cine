...
<main role="main">
    ...
    <div class="album py-5">
        <div class="container">
            ...
            <div>
                Dias proyecciones:
                <c:forEach var="diaproyecciones" items="${diasProyecciones}">
                    <div>
                        <span class="badge rounded-pill bg-warning text-dark">${diaproyecciones.key}</span>
                        <c:forEach var="proyeccion" items="${diaproyecciones.value}">
                            <span class="badge bg-success-light text-dark"><%--${proyeccion.comienzo}${proyeccion.sala.nombre}--%>${proyeccion.pelicula.titulo} ${proyeccion.comienzo}</span>
                        </c:forEach>
                    </div>
                </c:forEach>
            </div>
